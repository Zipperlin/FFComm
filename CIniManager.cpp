...
INI_RES CIniManager::OpenFile(const char* pathName, const char* type)
{
...
* ?  ??
******************************************************************************/
INI_RES CIniManager::GetKey(const char* mAttr, const char* cAttr, char* pValue)
{
...
* ?  ??
******************************************************************************/
int CIniManager::GetInt(const char* mAttr, const char* cAttr )
{
 int nRes = 0;
...
* ?  ??
******************************************************************************/
char *CIniManager::GetStr(const char* mAttr, const char* cAttr )
{
 memset( m_szKey,0,sizeof(m_szKey) );
